<form class="form-horizontal" method="post" action="">
    ...
    <div class="form-group">
        ...
        <div class="col-sm-5">  {{--{{ old('Student')['name'] }} 数据保持--}}
            <input type="text" class="form-control" id="name" name="Student[name]"
                   value="{{ old('Student')['name'] ?old('Student')['name'] : $student->name }}" placeholder="请输入学生姓名">
        </div>
        <div class="col-sm-5">
    ...
    <div class="form-group">
        ...
        <div class="col-sm-5">
            <input type="text" class="form-control" id="age" name="Student[age]"
                   value="{{ old('Student')['age'] ? old('Student')['age'] : $student->age }}" placeholder="请输入学生年龄">
        </div>
        <div class="col-sm-5">
